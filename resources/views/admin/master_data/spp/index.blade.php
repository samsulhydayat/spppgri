        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('spp.create') }}" class="btn btn-primary btn-icon-text btn-sm float-end"><i
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dataTableExample" class="table">
                            ...
                            @else
                                <tr>
                                    <td colspan="4" class="text-center text-secondary">Belum ada data SPP yang
                                        ditambahkan!
                                    </td>
                                </tr>
                            @endif
